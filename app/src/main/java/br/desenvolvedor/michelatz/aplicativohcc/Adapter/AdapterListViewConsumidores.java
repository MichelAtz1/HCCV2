...
public class AdapterListViewConsumidores extends BaseAdapter {
    ...
    public AdapterListViewConsumidores(Context context, ArrayList<DadosGerais> itens) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = mInflater.inflate(R.layout.list_item_consumidor, null);
        ((TextView) view.findViewById(R.id.txtMensagem)).setText(item.getTexto());
        ((ImageButton) view.findViewById(R.id.btnDelete5)).setTag(position);
        ((ImageButton) view.findViewById(R.id.btnEditar5)).setTag(position);
        return view;
    }
